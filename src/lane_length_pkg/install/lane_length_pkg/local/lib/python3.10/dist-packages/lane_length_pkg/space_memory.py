...
class SpaceMemoryNode(Node):
    def __init__(self):
        ...
        self._use_map = bool(self.get_parameter('use_map').value)
        ...
        self.sub_objects = self.create_subscription(
            String, '/perception/objects', self._objects_cb, 10)
    ...
    def _objects_cb(self, msg: String) -> None:
        pass  # reserved for future obstacle-aware space analysis
